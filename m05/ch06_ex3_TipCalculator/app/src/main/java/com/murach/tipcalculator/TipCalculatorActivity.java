...
public class TipCalculatorActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        //*****************************************************
        billAmountEditText.setOnKeyListener(new OnKeyListener() {
        ...
        percentSeekBar.setOnKeyListener(new OnKeyListener() {
            InputMethodManager imm = (InputMethodManager)
                    getSystemService(Context.INPUT_METHOD_SERVICE);
            @Override
            public boolean onKey(View view, int keyCode, KeyEvent event) {
        ...
        //*****************************************************
        roundingRadioGroup.setOnCheckedChangeListener(new OnCheckedChangeListener() {
            @Override
        ...
        roundingRadioGroup.setOnKeyListener(new OnKeyListener() {
            InputMethodManager imm = (InputMethodManager)
                    getSystemService(Context.INPUT_METHOD_SERVICE);
            @Override
            public boolean onKey(View view, int keyCode, KeyEvent event) {
